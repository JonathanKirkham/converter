...
function getFahrenheit() {
    ...
    document.getElementById('fahrenheit-result').innerHTML = `Fahrenheit: ${fahrenheit.toFixed(2)}°F`;
    return fahrenheit;
}
...
function getRankine() {
    ...
    document.getElementById('rankine-result').innerHTML = `Rankine: ${rankine.toFixed(2)}°R`;
    return rankine;
}

function getDelisle() {
    let delisle = 100 - Number(userInput.value) * 3 / 2;
    document.getElementById('delisle-result').innerHTML = `Delisle: ${delisle}°De`;
    return delisle;
}
...
function getReaumur() {
    ...
    document.getElementById('reaumur-result').innerHTML = `Réaumur: ${reaumur}°Ré`;
    return reaumur;
}

function getRomer() {
    const romer = Number(userInput.value) * 21 / 40 + 7.5;
    document.getElementById('romer-result').innerHTML = `Rømer: ${romer.toFixed(2)}°Rø`;
    return romer;
}
...
function getWedgewoodModern() {
    ...
    document.getElementById('wedgewood-modern-result').innerHTML = `WedgeW: ${wedgewoodModern.toFixed(3)}°W`;
